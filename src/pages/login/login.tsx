...
export default function Login() {
  ...
  const [isLoginIn, setIsLoginIn] = useRecoilState(loginState);
  ...
  return (
    <div className="min-h-[calc(100vh)] py-12 w-full h-full overflow-y-scroll bg-gray-50 flex flex-col justify-center bg-center z-[2]">
      <div>
        {/* <img
          src={loginimage}
          alt="bgimg"
        ...
        <div className="max-w-md w-full mx-auto bg-white p-8 border border-gray-300">
          <form className="form space-y-6">
            ...
            <div className="text-center">
              <button className="w-full bg-yellow-300 text-black font-bold h-8 text-xl">
                Login with YourD
              </button>
            </div>
            <div className="text-center">
            ...
            <div className="text-center">
              <button
                className="w-1/2 py-4   bg-black hover:bg-blue-799 rounded-xl text-yellow-300  text-2xl mt-4 "
                onClick={() => handleLogin()}
              >
                Login
              </button>
